...
data_tnum_adams <- tnum.query(query="subj:*Adams",max=200001)
data_tnum_alexander <- tnum.query(query="subj:*Alexander",max=200001)
data_tnum_bond <- tnum.query(query="subj:*Bond",max=200001)


data_tnum_og <- tnum.query(query="subj:*",max=200001)
