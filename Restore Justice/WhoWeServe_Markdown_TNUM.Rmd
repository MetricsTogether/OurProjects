...
start <- Sys.time()
for (i in 3:23 ){ 
  data_tnum_og <- rbind(data_tnum_og, tnum.query(query=paste0("subj:*",counties[i,]),max=200001))
}
...
data_tnum_og <- rbind(data_tnum_og, tnum.query(query=paste0("subj:*",counties[2,]),max=500001,start = 200001))
